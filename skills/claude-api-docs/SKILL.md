...
- **[api](docs/en/api)**: Comprehensive API reference, including completions, administration, and beta features.
...
- **[cli-sdks-libraries](docs/en/cli-sdks-libraries)**: Documentation for Claude CLI, client SDKs, libraries, and middleware.
