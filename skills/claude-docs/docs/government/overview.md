...
> | ---------------------- | ------------------------------------------------------------- |
> | A tenant administrator | [Tenant administration](/government/tenant-admin/overview)    |
> | An organization owner  | [Organization administration](/government/org-admin/overview) |
> | Any user               | [Your account](/government/account/overview)                  |
...
| -------------------------------------------------------- | --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**Tenant**](/government/tenant-admin/overview)          | Tenant administrators                         | Creating organizations, configuring identity and access (single sign-on, provisioning, and routing rules), distributing credits and seats, and managing who else is a tenant administrator. |
| [**Organization admin**](/government/org-admin/overview) | Organization owners and tenant administrators | Managing users and seats, setting usage tiers, viewing analytics, and configuring organization-level settings.                                                                              |
| [**Account**](/government/account/overview)              | Everyone                                      | Viewing your own profile, checking your usage limits, and managing where you're signed in.                                                                                                  |
...
Users reach your deployment in one of two ways, both of which are configured by a tenant administrator on the [Identity and access](/government/tenant-admin/identity-and-access) page:
...
* Read [**Tenant administration**](/government/tenant-admin/overview) if you're a tenant administrator managing the overall deployment.
* Read [**Organization administration**](/government/org-admin/overview) if you're an owner managing a single organization.
* Read [**Your account**](/government/account/overview) if you want to understand your own profile, usage, and sessions.
