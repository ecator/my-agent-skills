...
Go to Organization settings > Capabilities and turn the Claude Science toggle off. Members can no longer sign in to the app. Data already on members' computers stays there; see [How Claude Science works with your data](/claude-science/how-claude-science-works-with-your-data) for details.
