...
<Steps>
  ...
  <Step title="Grant Claude write access to the repository">
    Open an [Access bundle](/claude-tag/admins/add-connections#your-first-access-bundle), go to its **Repositories** tab, and add the repository. The Claude GitHub App must already be linked to your GitHub organization; see [Configure GitHub access](/claude-tag/admins/configure-github).
  </Step>

  <Step title="Attach the plugins to a scope">
    In the same bundle's **Plugins** section, select **+** and add your new marketplace. See [Attach plugins](/claude-tag/admins/add-connections#attach-plugins).
  </Step>
</Steps>
...
* [Attach plugins](/claude-tag/admins/add-connections#attach-plugins): how plugins and skills load into a scope
* [Configure GitHub access](/claude-tag/admins/configure-github): granting Claude write access to a repository
* [What Claude Tag remembers](/claude-tag/users/memory): when channel memory is the right place instead
