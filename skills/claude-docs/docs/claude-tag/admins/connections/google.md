...
Connecting Google Drive, Calendar, and Gmail lets Claude read documents, spreadsheets, calendar events, and email from any channel under the bundle's scope. You add it as a connection inside an [Access bundle](/claude-tag/admins/add-connections); the credential belongs to the agent, not to any person.
...
* [What this connection adds](/claude-tag/users/use-cases/find-answers): grounding answers in your team's documents
