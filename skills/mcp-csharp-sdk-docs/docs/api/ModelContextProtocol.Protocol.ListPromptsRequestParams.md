...
Represents the parameters used with a [PromptsList](ModelContextProtocol.Protocol.RequestMethods.html#ModelContextProtocol_Protocol_RequestMethods_PromptsList) request from a client to request
...
The server responds with a [ListPromptsResult](ModelContextProtocol.Protocol.ListPromptsResult.html) containing the available prompts.
