...
如果用户没有提供音乐或者提供的素材不合适，那么可以参考`assets/bgm`和`assets/fx`下面的音乐素材，同名的md文件为音频描述文件，可以作为参考。
...
调用示例：`pwsh -File "scripts\play.ps1" -Path "PATH\TO\demo.mp4"`
